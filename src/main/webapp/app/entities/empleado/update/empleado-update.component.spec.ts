...
describe('Empleado Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should update editForm', () => {
      const empleado: IEmpleado = { id: 456 };
      const idDepartamento: IDepartamento = { id: 3800 };
      empleado.idDepartamento = idDepartamento;

      activatedRoute.data = of({ empleado });
      comp.ngOnInit();

      expect(comp.departamentosSharedCollection).toContain(idDepartamento);
