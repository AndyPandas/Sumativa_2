...
export class DepartamentoUpdateComponent implements OnInit {
  ...
  protected updateForm(departamento: IDepartamento): void {
    ...
    this.jefesSharedCollection = this.jefeService.addJefeToCollectionIfMissing<IJefe>(
  ...
  protected loadRelationshipsOptions(): void {
    this.jefeService
      ...
      .pipe(map((jefes: IJefe[]) => this.jefeService.addJefeToCollectionIfMissing<IJefe>(jefes, ...(this.departamento?.jefes ?? []))))
