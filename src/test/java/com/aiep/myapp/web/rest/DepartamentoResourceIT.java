...
import static com.aiep.myapp.domain.DepartamentoAsserts.*;
...
import com.aiep.myapp.domain.Departamento;
import com.aiep.myapp.repository.DepartamentoRepository;
...
class DepartamentoResourceIT {
    ...
    private static final Integer DEFAULT_PRESUPUESTO_DEPARTAMENTO = 1;
    private static final Integer UPDATED_PRESUPUESTO_DEPARTAMENTO = 2;
